...
// todo    function main(app: qx.application.Standalone) {
    export function main() {
        ...
        var args:string[] = [""]; // GUI.App.argv;	// todo
...
// todo      IDE.init(<qx.ui.container.Composite>app.getRoot());
       IDE.init();
        ...
        if (prjDir) {
// todo           IDE.addProject(prjDir);
        } else {
// todo           if (args.indexOf("--restore") > -1) IDE.restorePreviousProjects();
        }
    }
...
//    qx.registry.registerMainMethod(main);		//eucaly: chained by boot module
